...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/webdav4-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13328&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/webdav4-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `webdav4` can be installed with:

```
conda install webdav4
```

It is possible to list all of the versions of `webdav4` available on your platform with:
